...
def Tele(ccx):
	...
	data = {
			'data': '__fluent_form_embded_post_id=19507&_fluentform_6_fluentformnonce=a53ae97c37&_wp_http_referer=%2Ftuition-payment%2F&names%5Bfirst_name%5D=&names%5Blast_name%5D=&email=gloosmoke3434%40gmail.com&input_text=NY&custom-payment-amount=1&payment_method=stripe&__stripe_payment_method_id='+str(pm)+'',
